...
This is a small Tutorial that shows you how to mine Duco on a wifi router.  <a target="_blank" rel="DuinoCoin" href="https://duinocoin.com">DuinoCoin</a> is a crypto that can even be mined on such low power devices.
